            ...
            {isSuccess ? (
                <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">
                        يمكنك الآن <a href="/login" className="text-primary hover:underline">تسجيل الدخول</a> باستخدام كلمة المرور الجديدة
                    </p>
                </div>
            ) : (
                <form onSubmit={handleSubmit} className="space-y-4 shadow-md border p-6 bg-white rounded-lg mt-10">
                    ...
                    <div>
                        ...
                        />
                        <p className="mt-1 text-xs text-gray-500">يجب أن تحتوي على الأقل 6 أحرف</p>
                    </div>

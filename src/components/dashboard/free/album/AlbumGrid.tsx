...
export const AlbumGrid = ({ albums, onCreate, onSelect, onDelete, onEdit }: AlbumGridProps) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-6">
      ...
      <div onClick={onCreate} className="rounded-lg overflow-hidden border-2 border-dashed border-muted-foreground/30 h-full flex flex-col items-center justify-center cursor-pointer hover:border-primary/50 transition-colors" style={{ minHeight: 250 }}>
